...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button = [[ InlineKeyboardButton("📦 Repo", url="https://github.com/httpaju/AJ-Auto-Approval"), InlineKeyboardButton("Updates 📢", url="t.me/AHMEN_BOTZZ") ],
              [ InlineKeyboardButton("➕️ Add Me To Your Chat ➕️", url=f"http://t.me/{approvedbot.username}?startgroup=botstart") ]]
    await client.send_message(chat_id=message.chat.id, text=f"**__Hello {message.from_user.mention} Iam Auto Approver Join Request Bot Just [Add Me To Your Group Channnl](http://t.me/{approvedbot.username}?startgroup=botstart) || Repo https://github.com/httpaju/AJ-Auto-Approval||**__", reply_markup=InlineKeyboardMarkup(button), disable_web_page_preview=True)
